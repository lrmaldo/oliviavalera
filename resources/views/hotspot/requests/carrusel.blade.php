    ...
    <div class="bg-white shadow-xl rounded-lg overflow-hidden w-full max-w-md border-t-4 border-pri-green">
        ...
        <div class="p-6">
            ...
            <div class="mt-4 relative">
                <div class="carousel overflow-hidden rounded-lg shadow-md border border-gray-200">
                    <img id="carousel-image" class="w-full h-64 object-cover transition-opacity duration-500"
                        src="" alt="Propuestas de campaña">
                    <div class="absolute inset-0 flex items-center justify-between px-2">
                        <button id="prev-btn"
                            class="bg-pri-red bg-opacity-70 hover:bg-opacity-90 text-white p-2 rounded-full">
                    ...
                    <div id="carousel-caption"
                        class="absolute bottom-0 left-0 right-0 bg-pri-green bg-opacity-80 text-white p-3 text-center">
                    </div>
                </div>
                ...
                <div class="p-0.5 bg-gradient-to-r from-pri-green to-pri-red rounded-xl shadow-lg">
                    <div class="bg-white p-5 rounded-lg">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-inner mb-4">
                            <div class="flex items-center justify-center">
                                ...
                                <p class="text-gray-700">
                                    Espere <span id="countdown"
                                        class="inline-block min-w-[2rem] text-xl font-bold text-pri-red bg-white py-1 px-2 rounded-lg shadow-sm border border-gray-100">15</span>
                        ...
                        <button id="continue-btn"
                            class="w-full bg-gray-400 text-white py-3 rounded-lg font-bold transition-all duration-300 hover:shadow-lg flex items-center justify-center disabled:opacity-80 disabled:cursor-not-allowed"
                            disabled>
        ...
        <div class="relative overflow-hidden">
            ...
            <div class="bg-white py-8 px-6 text-center relative">
                <div class="mb-6">
                    <span
                        class="inline-block px-4 py-1 rounded-full bg-pri-green text-white text-xs font-semibold mb-2">
                        CANDIDATA 2025
                    </span>
                ...
                <div class="flex flex-col items-center justify-center mb-6">
                    <div class="relative mb-4">
                        <div class="absolute inset-0 rounded-full border-4 border-pri-red opacity-75 animate-pulse">
                        </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="inline-block p-0.5 bg-gradient-to-r from-pri-green to-pri-red rounded-lg shadow-lg">
                        <a href="#contacto"
                            class="block bg-white hover:bg-gray-50 text-pri-green font-semibold py-2 px-8 rounded-md transition-all">
                    ...
                    <div class="flex justify-center space-x-6 mt-2">
                        <a href="#"
                            class="bg-white p-2 rounded-full shadow-sm border border-gray-100 text-pri-green hover:bg-pri-green hover:text-white transition-all duration-300">
                        ...
                        <a href="#"
                            class="bg-white p-2 rounded-full shadow-sm border border-gray-100 text-pri-red hover:bg-pri-red hover:text-white transition-all duration-300">
        ...
        <div class="bg-gray-100 p-3 text-center text-xs text-gray-500">
            <p>© {{ date('Y') }} Campaña de Olivia Valera para la Presidencia Municipal de Tierra Blanca, Veracruz
            </p>
        </div>
    </div>
